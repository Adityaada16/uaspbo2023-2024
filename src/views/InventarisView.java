...
public class InventarisView extends javax.swing.JFrame {
    ...
    private void showDataTable() {
        // Buat instance dari InventarisController
        ...
        String[] columnNames = {"ID", "Nama Barang", "Quantity", "Keterangan"};
        ...
        // Set model tabel ke tbInventaris
        tbInventaris.setModel(tableModel);
    }

    private void showDataInTable(List<Inventaris> listInventaris) {
        String[] columnNames = {"ID", "Nama Barang", "Quantity", "Keterangan"};
        DefaultTableModel tableModel = new DefaultTableModel(columnNames, 0);

        for (Inventaris inventaris : listInventaris) {
            Object[] rowData = {
                inventaris.getIdBarang(),
                inventaris.getNamaBarang(),
                inventaris.getQuantity(),
                inventaris.getKeterangan()
            };
            tableModel.addRow(rowData);
        }

        tbInventaris.setModel(tableModel); // tbInventaris adalah JTable untuk menampilkan data inventaris
    }
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(TfBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TfKeterangan, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButtonTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTambahActionPerformed
        ...
        String quantityStr = TfQty.getText();
        String keterangan = TfKeterangan.getText();

        // Membuat instance dari InventarisController
        InventarisController inventarisController = new InventarisController();

        try {
            // Validasi input menggunakan controller
            inventarisController.validateInventarisData(namaBarang, quantityStr);

            // Buat objek Inventaris
            Inventaris barang = new Inventaris();
            barang.setNamaBarang(namaBarang);
            barang.setQuantity(Integer.parseInt(quantityStr));
            barang.setKeterangan(keterangan);

            // Tambahkan barang ke database
            inventarisController.addBarang(barang);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        try {
            ...
            inventarisController.updateBarang(barang);

            // Refresh tabel setelah pembaruan
            showDataTable();
            resetField();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        int id = id_inventaris; // Ambil ID inventaris yang dipilih
        ...
        if (id != -1) {
            ...
            try {
                int confirm = JOptionPane.showConfirmDialog(this, "Apakah Anda yakin ingin menghapus inventaris dengan ID: " 
                        + id + "?", "Konfirmasi Penghapusan", JOptionPane.YES_NO_OPTION);
                if (confirm == JOptionPane.YES_OPTION) {
                    inventarisController.deleteBarang(id);
                    JOptionPane.showMessageDialog(this, "Data inventaris berhasil dihapus!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
                    resetField();
                    showDataTable();
                }
            } catch (Exception e) {
    ...
    private void tbInventarisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbInventarisMouseClicked
        ...
        int selectedRow = tbInventaris.getSelectedRow();

        // Pastikan ada baris yang dipilih
        if (selectedRow >= 0) {
            // Mendapatkan model tabel untuk mengakses data
            DefaultTableModel model = (DefaultTableModel) tbInventaris.getModel();
            ...
            id_inventaris = Integer.parseInt(id);
            TfBarang.setText(namaBarang);
            TfQty.setText(quantity);
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        InventarisController inventarisController = new InventarisController();
        List<Inventaris> listInventaris = inventarisController.searchByName(searchKeyword);
        showDataInTable(listInventaris);
    ...
    private void jButtonCsvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCsvActionPerformed
        ...
        DefaultTableModel tableModel = (DefaultTableModel) tbInventaris.getModel();
        
        // Membuat instance controller
        InventarisController controller = new InventarisController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InventarisView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventarisView().setVisible(true);
            }
        });
    }
